...
public class JhipstermongoappApp {

    private static final Logger log = LoggerFactory.getLogger(JhipstermongoappApp.class);

    private final Environment env;

    public JhipstermongoappApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipstermongoapp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipstermongoappApp.class);
